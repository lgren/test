...
public class ReflectionUtils {
    ...
    public static Object getFieldValue(final Object object, final String fieldName) {
        Field field = ofNullable(getDeclaredField(object, fieldName))
                .orElseThrow(() -> new IllegalArgumentException(String.format("Could not find field [%s] on target [%s]", fieldName, object)));
    ...
    public static Object invokeMethod(final Object object, final String methodName, final Class<?>[] parameterTypes, final Object[] parameters) {
        Method method = ofNullable(getDeclaredMethod(object, methodName, parameterTypes))
                .orElseThrow(() -> new IllegalArgumentException(String.format("Could not find method [%s] parameterType %s on target [%s]", methodName, Arrays.toString(parameterTypes), object)));
