 ...
 */
public class LTreeSimple<T, K, N> {
    // 特征 默认
     ...
     */
    public LTreeSimple(Collection<T> sourceColl, Function<T, K> getId, Function<T, K> getPId,
     ...
     */
    public static <T, K> LTreeSimple<T, K, Map<String, Object>> build(Collection<T> sourceColl, Function<T, K> getId, Function<T, K> getPId) {
        return new LTreeSimple<>(sourceColl, getId, getPId,
                m -> (Collection<Map<String, Object>>) m.get("_children"),
                (m, c) -> m.put("_children", c),
                t -> {
     ...
     * @param getPId     获取PID的方法
     */
    public static <T extends INode<T>, K> LTreeSimple<T, K, T> buildUseINode(Collection<T> sourceColl, Function<T, K> getId, Function<T, K> getPId) {
        return new LTreeSimple<>(sourceColl, getId, getPId, T::getChildren, T::setChildren, o -> o, o -> o);
    }
