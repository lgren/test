...
CREATE TABLE `ug40` (
  ...
  `YUG409` varchar(6) DEFAULT NULL COMMENT '鉴定状态：0 未鉴定 1 已鉴定未审核 2 已鉴定已审核 3 已执行销毁操作未执行延期操作n4 已执行延期操作未执行销毁操作 5 全部操作完成，不能再进行更改',
...
CREATE TABLE `ug61` (
  ...
  `YUG609` varchar(6) DEFAULT NULL COMMENT '交接标志（0-未交接，1-交接中,2-已回退，3-已接收）n',
  PRIMARY KEY (`YUG610`),
