...
public class GraphFindCycle {  
    ...
    class ServRel{  
        public String useServId;  //自己的id
        public String providerServId;  //引用节点，指向节点
    ...
    public static void main(String[] args) {  
        ...
        List<String> servList = new ArrayList<String>();  //单个节点列表
        servList.add("A");  
        servList.add("B");  
        servList.add("C");  
        servList.add("D");  
        ...
        List<ServRel> servRelList = new ArrayList<ServRel>(); //引用列表 
